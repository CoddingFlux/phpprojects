<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="addbook.php">Add Book</a></li>
                           ...
                           <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="issues.php">Issue New Book</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manageissue.php">Manage Issued Books</a></li>
                                </ul>
                            </li>
