...
<div class="welcome-area pt-100 pb-95">
    <div class="container">
        <div class="welcome-content text-center">
            <h5>Who Are We</h5>
            <h1>Welcome To My Jewelry Shopping Store</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse et urna nec ex dictum dapibus ac eget justo. Vivamus tristique, sapien id efficitur dignissim, sem justo laoreet tortor.</p>
            <p>Nunc cursus, felis id tristique pellentesque, justo justo bibendum mi, vel accumsan orci urna ac libero. Sed non efficitur metus.</p>
        </div>
    </div>
</div>
<div class="banner-area pb-70">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product-details.php"><img src="assets/img/banner/banner-2.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Plo Bag</h3>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product-details.php"><img src="assets/img/banner/banner-3.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Sunglass</h3>
                        <h4>Starting at <span>$79.00</span></h4>
                        <a href="#"><i class="fa fa-long-arrow-right"></i></a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-mission mb-30">
                    <h3>Our mission </h3>
                    <p>At Jewelry Shopping, our mission is to provide our customers with the finest quality jewelry, handcrafted with precision and care. We believe that every piece of jewelry should tell a unique story, and we strive to help our customers find or create pieces that resonate with their personal style and emotions.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
                <div class="single-mission mb-30">
